...
__all__ = ['SumXY', 'DummyEstimator', 'Intermediate', 'Higher', 'Sum1', 'Multiply10', 'NewParallel', 'make_pipe1',
           'make_pipe2', 'MinMaxClass', 'Min10', 'Max10', 'make_pipe_fit1', 'make_pipe_fit2', 'Min10direct',
...
class DummyClassifier (Component):
    ...
    def __init__ (self, project_op='max', statistic='mean', factor=1000, apply_func='simple',
        ...
        super().__init__ (data_converter='StandardConverter', **kwargs)
