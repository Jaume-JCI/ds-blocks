...
__all__ = ['save_csv', 'save_parquet', 'save_multi_index_parquet', 'save_keras_model', 'save_csv_gz', 'read_csv',
           'read_csv_gz', 'load_keras_model', 'estimator2io', 'result2io', 'get_specific_data_io_parameters', 'DataIO',
           'PandasIO', 'PickleIO', 'SklearnIO', 'NoSaverIO', 'data_io_factory', 'ModelPlotter', 'Profiler',
           'Comparator', 'camel_to_snake', 'snake_to_camel']
...
# Cell
_specific_params = ['path_results', 'load_result', 'save_result', 'path_models', 'load_model', 'save_model',
                       'load', 'save']

def get_specific_data_io_parameters (tag, **kwargs):
    suffix = f'_{tag}'
    n = len(suffix)
    return {k[:-n]:kwargs[k] for k in kwargs if k.endswith (suffix) and k[:-n] in _specific_params}
