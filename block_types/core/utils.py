...
__all__ = ['save_csv', 'save_parquet', 'save_multi_index_parquet', 'save_keras_model', 'save_csv_gz', 'read_csv',
           'read_csv_gz', 'DataIO', 'SklearnIO', 'NoSaverIO', 'ModelPlotter', 'camel_to_snake']
...
class NoSaverIO (DataIO):
    ...
    def __init__ (self,
                  ...
                  overwrite=True,  # TODO: change this to load=False
                  **kwargs):

        # the NoSaverComponent over-rides the following parameters:
        super().__init__ (fitting_load_func=None,
                          fitting_save_func=None,
                          save_fitting=False,
                          result_load_func=None,
                          result_save_func=None,
