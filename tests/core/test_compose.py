...
__all__ = ['column_transformer_data_fixture', 'multi_split_data_fixture',
           'test_pipeline_find_last_fitted_model_seq_others', 'SimpleMultiComponent', 'test_multi_comp_io',
           ...
           'test_show_result_statistics', 'test_pass_components', 'test_chain_folders', 'test_set_root', 'Transform1',
           'Transform2', 'SimplePipeline', 'test_pipeline_fit_apply', 'test_pipeline_fit_apply_bis',
           ...
           'test_construct_diagram', 'test_show_summary', 'test_make_pipeline', 'test_pipeline_factory',
           ...
           'test_pipeline_find_last_fitted_model_seq', 'TransformM', 'test_multi_modality', 'test_column_selector',
...
def test_pipeline_find_last_fitted_model_seq ():
    ...
    pipe2.A.raise_error = True
    pipe2.A.create_estimator()
    assert pipe2.A.estimator == Bunch()
    pipe2.B.raise_error = True
