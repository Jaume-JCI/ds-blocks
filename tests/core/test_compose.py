...
__all__ = ['column_transformer_data_fixture', 'multi_split_data_fixture',
           'test_pipeline_find_last_fitted_model_seq_others', 'test_pipeline_find_last_fitted_model_seq_others2',
           ...
           'test_set_root', 'Transform1', 'Transform2', 'SimplePipeline', 'test_pipeline_fit_apply',
           ...
           'test_pipeline_find_last_fitted_model_parallel', 'TransformM', 'test_multi_modality', 'test_column_selector',
...
def test_pipeline_find_last_fitted_model_parallel ():
    ...
    r1 = pipe1.fit_apply (X)
    print (r1)
    pipe2 = make_pipe_fit2 (path_results=path_results, verbose=2)
    # second
