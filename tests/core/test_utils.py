...
__all__ = ['DummyComponent', 'test_data_io_folder', 'dummy_component', 'test_data_io_chaining',
           'test_get_specific_data_io_parameters', 'test_data_io_factory', 'test_profiler', 'MyTransformComparator',
           'test_comparator', 'test_comparator2']
...
def test_get_specific_data_io_parameters ():
    data_io = DataIO ()
    config = data_io.get_specific_data_io_parameters (
